const config = require("../configs/app"),
    db = require("../models/NewsCategory"),
    {
        ErrorBadRequest,
        ErrorNotFound,
        ErrorUnauthorized,
...
const methods = {
    scopeSearch(req, limit, offset) {
        ...
        if (req.query.news_cate_name)
            $where["news_cate_name"] = {
                [Op.like]: "%" + req.query.news_cate_name + "%",
            };
    ...
    insert(data) {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                const res = methods.findById(inserted.news_cate_id);
    ...
    update(id, data) {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                await db.update(data, { where: { news_cate_id: id } });
                let res = methods.findById(obj.news_cate_id);
