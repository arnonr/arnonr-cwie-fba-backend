    ...
    insert(data) {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                const res = methods.findById(inserted.status_id);
    ...
    update(id, data) {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                await db.update(data, { where: { status_id: id } });
                let res = methods.findById(obj.status_id);
